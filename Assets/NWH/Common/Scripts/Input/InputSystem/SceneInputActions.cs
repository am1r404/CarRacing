...
namespace NWH.Common.Input
{
    ...
    ""controlSchemes"": []
        ...
        ~@SceneInputActions()
        {
            Debug.Assert(!m_CameraControls.enabled, "This will cause a leak and performance issues, SceneInputActions.CameraControls.Disable() has not been called.");
            Debug.Assert(!m_SceneControls.enabled, "This will cause a leak and performance issues, SceneInputActions.SceneControls.Disable() has not been called.");
        }
