...
namespace DaiMangou.ProRadarBuilder
{
    ...
    public class CustomUITargetData
    {
        ...
        public Font DistanceTextFont
        {
            get
            {

                if (df == null)
                    df = Resources.GetBuiltinResource<Font>("Arial.ttf");
                return df;
            ...
            for (var b = 0; b < blipsCount; b++)
            {
                ...
                for (var o = 0; o < trackedObjectCount; o++)
                {
                    ...
                    if (trackers[b].uIData[o] == null)
                    {
                        ...
                        distanceText.AddComponent<Text>();
                        ...
                        trackers[b].uIData[o].text = nameText.GetComponent<Text>();
                        trackers[b].uIData[o].text.horizontalOverflow = HorizontalWrapMode.Overflow;
                        trackers[b].uIData[o].distanceText = distanceText.GetComponent<Text>();
                        trackers[b].uIData[o].distanceText.horizontalOverflow = HorizontalWrapMode.Overflow;
                        ...
                        trackers[b].uIData[o].text.alignment = TextAnchor.MiddleCenter;

                        var distanceTextData = distanceText.GetComponent<RectTransform>();
                        distanceTextData.sizeDelta = new Vector2(163.3f, 25);
                        trackers[b].uIData[o].distanceText.alignment = TextAnchor.MiddleCenter;
...

                {
                    ...
                    if (distance > 0 && distance < sceneScaledDistance && onScreen)
                    {
                        ...
                        if (customUITargetDataset[blipPos].showDistance)
                        {
                            ...
                            theDistanceText.text = distance.ToString();
                        }
                        else
                        {
